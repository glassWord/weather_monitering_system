...
class ModernDarkApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # Predicted data section (top left)
        self.predicted_frame = tk.Frame(left_frame, bg='#1E1E1E', borderwidth=2, relief='groove')
        self.predicted_frame.pack(side=tk.TOP, fill=tk.BOTH, expand=True, padx=20, pady=20)

        tk.Label(self.predicted_frame, text="Predicted Data", font=self.font_large, fg='#90EE90', bg='#1E1E1E').pack(anchor='center', pady=10)
        
        self.label_temp = tk.Label(self.predicted_frame, text="Predicted Temperature: ", font=("Helvetica", 30), fg='#90EE90', bg='#1E1E1E')
        self.label_temp.pack(pady=5, anchor='center')

        self.label_humid = tk.Label(self.predicted_frame, text="Predicted Humidity: ", font=("Helvetica", 30), fg='#90EE90', bg='#1E1E1E')
        self.label_humid.pack(pady=5, anchor='center')

        self.label_air = tk.Label(self.predicted_frame, text="Predicted Air Quality: ", font=("Helvetica", 30), fg='#90EE90', bg='#1E1E1E')
        self.label_air.pack(pady=5, anchor='center')
    ...
    def create_graphs(self, parent):
        ...
        self.fig, (self.ax_temp, self.ax_humid, self.ax_air) = plt.subplots(3, 1, figsize=(15, 20))  # Increased size
